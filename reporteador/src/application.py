...
def create_app() -> Flask:
    ...
    app.add_url_rule("/download-policy",view_func=PolicyController.download_policy,methods=["GET"])
    app.add_url_rule("/policy.pdf", methods=["GET"], view_func=PolicyController.download_policy)
